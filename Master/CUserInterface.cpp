...
void CUserInterFace::Draw(void)
{
	...
	//下絵
	Sprite_Draw(TEX_MAP, 860.0f, 10.0f, 0.0f, 0.0f, 120, 120);
	//プレイヤ
	Sprite_Draw(TEX_Player_Icon, 890.0f + playermatrix._41, 55.0f - playermatrix._43, 0.0f, 0.0f, 60, 30);
	...
	for (int i = 0; i < ENEMY_MAX; i++)
	{
		...
		if (enemyget)
		{
			...
			Sprite_Draw(TEX_ENEMY_ICON, 915.0f + enemymatrix._41, 70.0f - enemymatrix._43, 0.0f, 0.0f, 6, 6);
		}
	}
	//------------------------------------------------------------------
