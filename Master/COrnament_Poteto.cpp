...
//	破棄
//=============================================================================
COrnament_Poteto::~COrnament_Poteto()
{
...
void COrnament_Poteto::Initialize(ORNAMENT_EMITTER *Emitter)
{
	...
	Thing_Normal_model = GetNormalModel(MODELL_POTETO);
...
void COrnament_Poteto::Finalize(void)
{
...
void COrnament_Poteto::Update(void)
{
	if (m_Enable)
	{
		//エフェクト処理を行う
...
void COrnament_Poteto::Draw(void)
{
	if (m_Enable)
	{
...
void COrnament_Poteto::Damage(void)
{
	int i;
	C3DObj *enemy;
	THING *thingenemy;
