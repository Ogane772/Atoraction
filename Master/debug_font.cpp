...
//	LPDIRECT3DDEVICE9 pDevice = mochi_GetDevice();
	D3DXCreateFont(CGameObj::m_pD3DDevice, 18, 0, 0, 0, FALSE, SHIFTJIS_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, "Terminal", &g_pD3DXFont);
...
{
#if defined(_DEBUG) || defined(DEBUG)
	RECT rect = { x, y, WINDOW_WIDTH, WINDOW_HIGHT
	};
