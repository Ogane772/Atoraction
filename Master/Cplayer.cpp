...
{
	if (g_CosterMode)//繧ｳ繝ｼ繧ｹ繧ｿ繝ｼ縺ｮ譎・
	{
		m_mtxTranslation *= Move(FLONT, SPEED);
	}
	if (!g_CosterMode)//繧ｳ繝ｼ繧ｹ繧ｿ繝ｼ縺倥ｃ縺ｪ縺・→縺・
	{
		...
		if (Keyboard_IsPress(DIK_W))
		{
			...
			{
				Model_Angle(true);//繧｢繝ｳ繧ｰ繝ｫ繝輔Λ繧ｰ縺荊rue縺縺｣縺溘ｉ蜿ｳ蝗櫁ｻ｢false蟾ｦ
			}
...
void CPlayer::Player_Initialize(void)
{
	...
	NxMat33 mat1;
	//mat1.rotZ(0);
	NxVec3 scaleDwarf = NxVec3(1, 1, 1);	//	繝｢繝・Ν繧ｹ繧ｱ繝ｼ繝ｫ
	NxVec3 BBDwarf = NxVec3(1.0f, 1.0f, 1.0f);	//	蠖薙◆繧雁愛螳壹・螟ｧ縺阪＆
